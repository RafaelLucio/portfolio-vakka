...
$(function () {
	...
	window.mobilecheck = function () {
		...
		check = checkMobile(navigator.userAgent || navigator.vendor || window.opera);
		return check;
	};
	...
	$sectionPage.css('top', heightScreen);
	...
	$(window).scroll(function () {
		...
		if ($(this).scrollTop() > heightScreen - 70) {
